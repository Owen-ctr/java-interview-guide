...
- **入门必答**：[『== 和 equals 有什么区别？』](#和-equals-有什么区别)、[『为什么重写 equals() 必须重写 hashCode()？』](#为什么重写-equals-必须重写-hashcode)、[『基本类型和包装类有什么区别？』](#基本类型和包装类有什么区别)、[『Java 是值传递还是引用传递？』](#java-是值传递还是引用传递)、[『重载（Overload）和重写（Override）有什么区别？』](#重载-overload-和重写-override-有什么区别)、[『接口和抽象类有什么区别？』](#接口和抽象类有什么区别)、[『String 为什么被设计成不可变的？』](#string-为什么被设计成不可变的)、[『异常体系是怎样的？受检异常和非受检异常有什么区别？』](#异常体系是怎样的-受检异常和非受检异常有什么区别)
- **进阶追问**：[『Object 类有哪些常用方法？』](#object-类有哪些常用方法)、[『static 关键字有什么作用？』](#static-关键字有什么作用)、[『final、finally、finalize 有什么区别？』](#final、finally、finalize-有什么区别)、[『String、StringBuilder、StringBuffer 有什么区别？』](#string、stringbuilder、stringbuffer-有什么区别)、[『try-catch-finally 中 return 与 finally 的执行顺序？』](#try-catch-finally-中-return-与-finally-的执行顺序)
- **深入原理**：[『泛型擦除是什么？带来哪些限制？』](#泛型擦除是什么-带来哪些限制)、[『反射是什么？有哪些用法和代价？』](#反射是什么-有哪些用法和代价)、[『注解是什么？元注解有哪些？』](#注解是什么-元注解有哪些)、[『深拷贝和浅拷贝有什么区别？怎么实现深拷贝？』](#深拷贝和浅拷贝有什么区别-怎么实现深拷贝)
